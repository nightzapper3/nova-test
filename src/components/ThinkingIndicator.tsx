      ...
      <div className="bg-chat-assistant border border-border rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
        <div className="flex items-center gap-2">
          <div className="flex gap-1.5">
            ...
            <span className="h-2 w-2 rounded-full bg-primary/60 animate-bounce [animation-delay:200ms] [animation-duration:1.4s]" />
            <span className="h-2 w-2 rounded-full bg-primary/60 animate-bounce [animation-delay:400ms] [animation-duration:1.4s]" />
          </div>
